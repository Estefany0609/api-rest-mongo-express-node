...
import { getAverage, newProfile, readSheet, getTickerSM, getHistoricoDiario, getIndustrias, getSectores, getSubIndustrias } from "../controllers/historical.controller.js";
...
router.get("/fileGoogle", requireToken, readSheet);
